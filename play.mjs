 ...
 */
export const downloadInstagramReel = async (instagramReelUrl) => {
	console.log(`Preparing to download reel from URL: ${instagramReelUrl}...`);
	...
	try {
		...
		console.log('Navigating to sssinstagram.com...');
		...
		console.log('Entering Instagram reel URL...');
		...
		console.log('Waiting for download options to appear...');
